      ...
      <div className="container-fluid px-6">
        <div className="flex items-center justify-between h-[70px]">
          ...
          <div className="hidden md:flex items-center space-x-2 flex-1 ml-8">
            <a href="/caselogs" className="px-5 py-3 text-white hover:bg-white/10 transition-colors text-base font-light">
              Case Logs
            </a>
            ...
            <div className="relative">
              <button
                ...
                className="px-5 py-3 text-white hover:bg-white/10 transition-colors text-base font-light flex items-center"
              >
                Reports
            ...
            <a href="/accounts" className="px-5 py-3 text-white hover:bg-white/10 transition-colors text-base font-light">
              User Accounts
            </a>
          </div>
